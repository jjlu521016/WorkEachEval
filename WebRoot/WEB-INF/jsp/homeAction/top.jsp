	...
	<div id="Head1">
		<div id="Logo">
			...
			<a id="msgLink" href="javascript:void(0)"></a> <font color="#0000CC"
				style="color: #F1F9FE; font-size: 28px; font-family: Arial Black, Arial">作业互评系统</font>
...
<%-- 					<s:a action="user_editInfoUI.action?id=9"><img border="0" width="13" height="14" --%>
<%-- 					src="${pageContext.request.contextPath}/style/images/top/user_setup.gif" />个人设置</s:a> --%>
			</div>
