...
public class QuestionAction extends BaseAction<Questions> {
	...
	public String list() throws Exception {
		...
		// new QueryHelper(Questions.class,
		// "s").preparePageBean(questionService, pageNum, pageSize);
	...
	public String add() throws Exception {
		...
		/*
		 * 添加一个FLG位， 1表示选择 2表示判断 3表示普通答案 4表示高级答案
		 */
		...
		case 2:
			// 处理判断题
			String judge = request.getParameter("judgeAnswer");// 如果单选按钮没有选
																// 则这个变量为NULL
			System.out
					.println("=======================================================");
